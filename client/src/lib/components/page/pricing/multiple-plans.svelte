  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="mt-16 flex justify-center">
      <fieldset aria-label="Payment frequency">
        <div
          class="ring-base-200 grid grid-cols-2 gap-x-1 rounded-full p-1 text-center text-xs font-semibold leading-5 ring-1 ring-inset">
      ...
      {#each plans as plan}
        <div
          ...
          <div class="flex items-center justify-between gap-x-4">
            ...
            {#if plan.cta}
              <p
                class="bg-primary/10 text-primary rounded-full px-2.5 py-1 text-xs font-semibold leading-5">
                Most popular
              </p>
            {/if}
          </div>
