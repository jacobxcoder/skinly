<script lang="ts">
  const hero = {
    ...
    secondaryButton: {
      ...
      link: 'https://twitter.com/jacob_the_coder'
    },
    ctaButton: {
      text: 'Get started',
      link: '/docs'
...
<div class="mx-auto max-w-2xl px-8 py-16 sm:py-24 lg:py-32">
  <div class="hidden sm:mb-8 sm:flex sm:justify-center">
    <div
      class="text-base-content-secondary ring-base-300 relative rounded-full
                    px-3 py-1 text-sm leading-6 ring-1">
      {hero.note.text}
      <a href={hero.note.link} target="_blank" class="text-primary font-semibold">
        {hero.note.linkText}
      </a>
    </div>
  </div>
  <div class="text-center">
    ...
    <p class="text-base-content-secondary mt-6 leading-8">
      {hero.subtitle}
    </p>
    <div class="mt-10 flex items-center justify-center gap-x-6">
      <a
        ...
        target="_blank"
        class="link text-sm font-semibold leading-6 no-underline">
        {hero.secondaryButton.text}
      </a>

      <a href={hero.ctaButton.link} class="btn btn-primary font-semibold">
        {hero.ctaButton.text}
      </a>
    </div>
  </div>
